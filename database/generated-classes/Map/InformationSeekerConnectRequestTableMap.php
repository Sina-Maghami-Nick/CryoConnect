...
use \InformationSeekerConnectRequest;
use \InformationSeekerConnectRequestQuery;
...
class InformationSeekerConnectRequestTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.InformationSeekerConnectRequestTableMap';
     ...
     */
    const OM_CLASS = '\\InformationSeekerConnectRequest';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'InformationSeekerConnectRequest';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\InformationSeekerConnectRequest');
        $this->setPackage('');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \InformationSeekerConnectRequest) { // it's a model object
