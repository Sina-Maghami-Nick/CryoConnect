...
use \InformationSeekerLanguages;
use \InformationSeekerLanguagesQuery;
...
class InformationSeekerLanguagesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.InformationSeekerLanguagesTableMap';
     ...
     */
    const OM_CLASS = '\\InformationSeekerLanguages';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'InformationSeekerLanguages';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\InformationSeekerLanguages');
        $this->setPackage('');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \InformationSeekerLanguages) { // it's a model object
