...
use \CryosphereWhat as ChildCryosphereWhat;
use \CryosphereWhatQuery as ChildCryosphereWhatQuery;
...
abstract class ExpertCryosphereWhat implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ExpertCryosphereWhatTableMap';
    ...
    /**
     * Initializes internal state of Base\ExpertCryosphereWhat object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\ExpertCryosphereWhat The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\ExpertCryosphereWhat'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\ExpertCryosphereWhat
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ExpertCryosphereWhat (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ExpertCryosphereWhat Clone of current object.
     * @throws PropelException
     */
