 ...
 *
 * @method     \InformationSeekersQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class InformationSeekerProfessionQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\InformationSeekerProfessionQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'cryo_connect', $modelName = '\\InformationSeekerProfession', $modelAlias = null)
    {
    ...
    public function prune($informationSeekerProfession = null)
    {
        if ($informationSeekerProfession) {
            throw new LogicException('InformationSeekerProfession object has no primary key');
