...
use \InformationSeekerConnectRequestCryosphereWhat as ChildInformationSeekerConnectRequestCryosphereWhat;
use \InformationSeekerConnectRequestCryosphereWhatQuery as ChildInformationSeekerConnectRequestCryosphereWhatQuery;
use \DateTime;
use \Exception;
use \PDO;
use Map\CryosphereWhatTableMap;
use Map\ExpertCryosphereWhatTableMap;
use Map\InformationSeekerConnectRequestCryosphereWhatTableMap;
...
abstract class CryosphereWhat implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\CryosphereWhatTableMap';
    ...
    /**
     * The value for the cryosphere_what _name field.
     *
     * @var        string
     */
    protected $cryosphere_what _name;
    ...
    /**
     * Initializes internal state of Base\CryosphereWhat object.
     * @see applyDefaults()
     */
    ...
    /**
     * Get the [cryosphere_what _name] column value.
     *
     * @return string
     */
    public function getCryosphereWhat Name()
    {
        return $this->cryosphere_what _name;
    }
     ...
     * @return $this|\CryosphereWhat The current object (for fluent API support)
     */
    ...
    /**
     * Set the value of [cryosphere_what _name] column.
     *
     * @param string $v new value
     * @return $this|\CryosphereWhat The current object (for fluent API support)
     */
    public function setCryosphereWhat Name($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->cryosphere_what _name !== $v) {
            $this->cryosphere_what _name = $v;
            $this->modifiedColumns[CryosphereWhatTableMap::COL_CRYOSPHERE_WHAT _NAME] = true;
        }

        return $this;
    } // setCryosphereWhat Name()
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CryosphereWhatTableMap::translateFieldName('CryosphereWhat Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cryosphere_what _name = (null !== $col) ? (string) $col : null;
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\CryosphereWhat'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->expertCryosphereWhatsScheduledForDeletion !== null) {
                if (!$this->expertCryosphereWhatsScheduledForDeletion->isEmpty()) {
                    \ExpertCryosphereWhatQuery::create()
            ...
            if ($this->informationSeekerConnectRequestCryosphereWhatsScheduledForDeletion !== null) {
                if (!$this->informationSeekerConnectRequestCryosphereWhatsScheduledForDeletion->isEmpty()) {
                    \InformationSeekerConnectRequestCryosphereWhatQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CryosphereWhatTableMap::COL_CRYOSPHERE_WHAT _NAME)) {
            $modifiedColumns[':p' . $index++]  = 'cryosphere_what _name';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id':
                        ...
                        break;
                    case 'cryosphere_what _name':
                        $stmt->bindValue($identifier, $this->cryosphere_what _name, PDO::PARAM_STR);
                        break;
                    case 'timestamp':
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                return $this->getCryosphereWhat Name();
                break;
            case 2:
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getCryosphereWhat Name(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                $this->setCryosphereWhat Name($value);
                break;
            case 2:
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setCryosphereWhat Name($arr[$keys[1]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CryosphereWhatTableMap::COL_CRYOSPHERE_WHAT _NAME)) {
            $criteria->add(CryosphereWhatTableMap::COL_CRYOSPHERE_WHAT _NAME, $this->cryosphere_what _name);
        }
        if ($this->isColumnModified(CryosphereWhatTableMap::COL_TIMESTAMP)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CryosphereWhat (or compatible) type.
    ...
    {
        $copyObj->setCryosphereWhat Name($this->getCryosphereWhat Name());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CryosphereWhat Clone of current object.
     * @throws PropelException
     */
    ...
    public function initExpertCryosphereWhats($overrideExisting = true)
    {
        ...
        $this->collExpertCryosphereWhats->setModel('\ExpertCryosphereWhat');
    }
    ...
    public function initInformationSeekerConnectRequestCryosphereWhats($overrideExisting = true)
    {
        ...
        $this->collInformationSeekerConnectRequestCryosphereWhats->setModel('\InformationSeekerConnectRequestCryosphereWhat');
    }
    ...
    {
        $this->id = null;
        $this->cryosphere_what _name = null;
        $this->timestamp = null;
        $this->alreadyInSave = false;
        $this->clearAllReferences();
        $this->applyDefaultValues();
