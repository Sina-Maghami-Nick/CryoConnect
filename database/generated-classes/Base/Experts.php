...
use \ExpertAffiliation as ChildExpertAffiliation;
...
use \ExpertContact as ChildExpertContact;
...
use \ExpertCryosphereWhatSpecefic as ChildExpertCryosphereWhatSpecefic;
use \ExpertCryosphereWhatSpeceficQuery as ChildExpertCryosphereWhatSpeceficQuery;
use \ExpertFieldWork as ChildExpertFieldWork;
...
abstract class Experts implements ActiveRecordInterface
{
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->expertCryosphereWhatSpeceficsScheduledForDeletion !== null) {
                if (!$this->expertCryosphereWhatSpeceficsScheduledForDeletion->isEmpty()) {
                    \ExpertCryosphereWhatSpeceficQuery::create()
    ...
    public function initExpertAffiliations($overrideExisting = true)
    {
        ...
        $this->collExpertAffiliations->setModel('\ExpertAffiliation');
    }
    ...
    public function initExpertContacts($overrideExisting = true)
    {
        ...
        $this->collExpertContacts->setModel('\ExpertContact');
    }
    ...
    public function initExpertCryosphereWhatSpecefics($overrideExisting = true)
    {
        ...
        $this->collExpertCryosphereWhatSpecefics->setModel('\ExpertCryosphereWhatSpecefic');
    }
    ...
    public function initExpertFieldWorks($overrideExisting = true)
    {
        ...
        $this->collExpertFieldWorks->setModel('\ExpertFieldWork');
    }
    ...
    public function initExpertWheres($overrideExisting = true)
    {
        ...
        $this->collExpertWheres->setModel('\ExpertWhere');
    }
