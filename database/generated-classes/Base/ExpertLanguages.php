...
abstract class ExpertLanguages implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ExpertLanguagesTableMap';
    ...
    /**
     * Initializes internal state of Base\ExpertLanguages object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\ExpertLanguages The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\ExpertLanguages'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ExpertLanguages (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ExpertLanguages Clone of current object.
     * @throws PropelException
     */
