...
use \Exception;
use \PDO;
use Map\InformationSeekerConnectRequestTableMap;
 ...
 *
 * @method     \InformationSeekersQuery|\InformationSeekerConnectRequestCryosphereWhatQuery|\InformationSeekerConnectRequestCryosphereWhereQuery|\InformationSeekerConnectRequestLanguagesQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class InformationSeekerConnectRequestQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\InformationSeekerConnectRequestQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'cryo_connect', $modelName = '\\InformationSeekerConnectRequest', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \InformationSeekerConnectRequestCryosphereWhat object
     *
     * @param \InformationSeekerConnectRequestCryosphereWhat|ObjectCollection $informationSeekerConnectRequestCryosphereWhat the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildInformationSeekerConnectRequestQuery The current query, for fluid interface
     */
    ...
    {
        if ($informationSeekerConnectRequestCryosphereWhat instanceof \InformationSeekerConnectRequestCryosphereWhat) {
            return $this
            ...
            throw new PropelException('filterByInformationSeekerConnectRequestCryosphereWhat() only accepts arguments of type \InformationSeekerConnectRequestCryosphereWhat or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \InformationSeekerConnectRequestCryosphereWhatQuery A secondary query class using the current class as primary query
     */
    public function useInformationSeekerConnectRequestCryosphereWhatQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'InformationSeekerConnectRequestCryosphereWhat', '\InformationSeekerConnectRequestCryosphereWhatQuery');
    }

    /**
     * Filter the query by a related \InformationSeekerConnectRequestCryosphereWhere object
     *
     * @param \InformationSeekerConnectRequestCryosphereWhere|ObjectCollection $informationSeekerConnectRequestCryosphereWhere the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildInformationSeekerConnectRequestQuery The current query, for fluid interface
     */
    ...
    {
        if ($informationSeekerConnectRequestCryosphereWhere instanceof \InformationSeekerConnectRequestCryosphereWhere) {
            return $this
            ...
            throw new PropelException('filterByInformationSeekerConnectRequestCryosphereWhere() only accepts arguments of type \InformationSeekerConnectRequestCryosphereWhere or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \InformationSeekerConnectRequestCryosphereWhereQuery A secondary query class using the current class as primary query
     */
    public function useInformationSeekerConnectRequestCryosphereWhereQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'InformationSeekerConnectRequestCryosphereWhere', '\InformationSeekerConnectRequestCryosphereWhereQuery');
    }

    /**
     * Filter the query by a related \InformationSeekerConnectRequestLanguages object
     *
     * @param \InformationSeekerConnectRequestLanguages|ObjectCollection $informationSeekerConnectRequestLanguages the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildInformationSeekerConnectRequestQuery The current query, for fluid interface
     */
    ...
    {
        if ($informationSeekerConnectRequestLanguages instanceof \InformationSeekerConnectRequestLanguages) {
            return $this
            ...
            throw new PropelException('filterByInformationSeekerConnectRequestLanguages() only accepts arguments of type \InformationSeekerConnectRequestLanguages or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \InformationSeekerConnectRequestLanguagesQuery A secondary query class using the current class as primary query
     */
    public function useInformationSeekerConnectRequestLanguagesQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'InformationSeekerConnectRequestLanguages', '\InformationSeekerConnectRequestLanguagesQuery');
    }
