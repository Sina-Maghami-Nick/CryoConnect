 ...
 *
 * @method     \CountriesQuery|\InformationSeekerAffiliationQuery|\InformationSeekerConnectRequestQuery|\InformationSeekerContactQuery|\InformationSeekerLanguagesQuery|\InformationSeekerProfessionQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class InformationSeekersQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\InformationSeekersQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'cryo_connect', $modelName = '\\InformationSeekers', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \InformationSeekerAffiliation object
     *
     * @param \InformationSeekerAffiliation|ObjectCollection $informationSeekerAffiliation the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildInformationSeekersQuery The current query, for fluid interface
     */
    ...
    {
        if ($informationSeekerAffiliation instanceof \InformationSeekerAffiliation) {
            return $this
            ...
            throw new PropelException('filterByInformationSeekerAffiliation() only accepts arguments of type \InformationSeekerAffiliation or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \InformationSeekerAffiliationQuery A secondary query class using the current class as primary query
     */
    public function useInformationSeekerAffiliationQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'InformationSeekerAffiliation', '\InformationSeekerAffiliationQuery');
    }

    /**
     * Filter the query by a related \InformationSeekerConnectRequest object
     *
     * @param \InformationSeekerConnectRequest|ObjectCollection $informationSeekerConnectRequest the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildInformationSeekersQuery The current query, for fluid interface
     */
    ...
    /**
     * Filter the query by a related \InformationSeekerContact object
     *
     * @param \InformationSeekerContact|ObjectCollection $informationSeekerContact the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildInformationSeekersQuery The current query, for fluid interface
     */
    ...
    {
        if ($informationSeekerContact instanceof \InformationSeekerContact) {
            return $this
            ...
            throw new PropelException('filterByInformationSeekerContact() only accepts arguments of type \InformationSeekerContact or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \InformationSeekerContactQuery A secondary query class using the current class as primary query
     */
    public function useInformationSeekerContactQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'InformationSeekerContact', '\InformationSeekerContactQuery');
    }

    /**
     * Filter the query by a related \InformationSeekerLanguages object
     *
     * @param \InformationSeekerLanguages|ObjectCollection $informationSeekerLanguages the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildInformationSeekersQuery The current query, for fluid interface
     */
    ...
    {
        if ($informationSeekerLanguages instanceof \InformationSeekerLanguages) {
            return $this
            ...
            throw new PropelException('filterByInformationSeekerLanguages() only accepts arguments of type \InformationSeekerLanguages or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \InformationSeekerLanguagesQuery A secondary query class using the current class as primary query
     */
    public function useInformationSeekerLanguagesQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'InformationSeekerLanguages', '\InformationSeekerLanguagesQuery');
    }

    /**
     * Filter the query by a related \InformationSeekerProfession object
     *
     * @param \InformationSeekerProfession|ObjectCollection $informationSeekerProfession the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildInformationSeekersQuery The current query, for fluid interface
     */
    ...
    {
        if ($informationSeekerProfession instanceof \InformationSeekerProfession) {
            return $this
            ...
            throw new PropelException('filterByInformationSeekerProfession() only accepts arguments of type \InformationSeekerProfession or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \InformationSeekerProfessionQuery A secondary query class using the current class as primary query
     */
    public function useInformationSeekerProfessionQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'InformationSeekerProfession', '\InformationSeekerProfessionQuery');
    }
