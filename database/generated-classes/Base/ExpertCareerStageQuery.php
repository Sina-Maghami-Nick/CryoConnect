 ...
 *
 * @method     \ExpertsQuery|\CareerStageQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class ExpertCareerStageQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\ExpertCareerStageQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'cryo_connect', $modelName = '\\ExpertCareerStage', $modelAlias = null)
    {
     ...
     *
     * @param \CareerStage|ObjectCollection $careerStage The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($careerStage instanceof \CareerStage) {
            return $this
            ...
            throw new PropelException('filterByCareerStage() only accepts arguments of type \CareerStage or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \CareerStageQuery A secondary query class using the current class as primary query
     */
    public function useCareerStageQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'CareerStage', '\CareerStageQuery');
    }
    ...
    public function prune($expertCareerStage = null)
    {
        if ($expertCareerStage) {
            throw new LogicException('ExpertCareerStage object has no primary key');
