...
use \Exception;
use \PDO;
use Map\CryosphereWhereTableMap;
 ...
 *
 * @method     \ExpertWhereQuery|\InformationSeekerConnectRequestCryosphereWhereQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class CryosphereWhereQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\CryosphereWhereQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'cryo_connect', $modelName = '\\CryosphereWhere', $modelAlias = null)
    {
