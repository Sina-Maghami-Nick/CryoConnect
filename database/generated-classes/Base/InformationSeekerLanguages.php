...
abstract class InformationSeekerLanguages implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\InformationSeekerLanguagesTableMap';
    ...
    /**
     * Initializes internal state of Base\InformationSeekerLanguages object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\InformationSeekerLanguages The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\InformationSeekerLanguages'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\InformationSeekerLanguages
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \InformationSeekerLanguages (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \InformationSeekerLanguages Clone of current object.
     * @throws PropelException
     */
