...
use \ExpertCareerStage as ChildExpertCareerStage;
use \ExpertCareerStageQuery as ChildExpertCareerStageQuery;
use \DateTime;
use \Exception;
use \PDO;
use Map\CareerStageTableMap;
...
abstract class CareerStage implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\CareerStageTableMap';
    ...
    /**
     * Initializes internal state of Base\CareerStage object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\CareerStage The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\CareerStage'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CareerStage (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CareerStage Clone of current object.
     * @throws PropelException
     */
    ...
    public function initExpertCareerStages($overrideExisting = true)
    {
        ...
        $this->collExpertCareerStages->setModel('\ExpertCareerStage');
    }
