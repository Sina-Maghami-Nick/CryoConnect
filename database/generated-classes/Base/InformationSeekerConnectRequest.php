...
abstract class InformationSeekerConnectRequest implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\InformationSeekerConnectRequestTableMap';
    ...
    /**
     * Initializes internal state of Base\InformationSeekerConnectRequest object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\InformationSeekerConnectRequest The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\InformationSeekerConnectRequest'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->informationSeekerConnectRequestCryosphereWheresScheduledForDeletion !== null) {
                if (!$this->informationSeekerConnectRequestCryosphereWheresScheduledForDeletion->isEmpty()) {
                    \InformationSeekerConnectRequestCryosphereWhereQuery::create()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\InformationSeekerConnectRequest
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \InformationSeekerConnectRequest (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \InformationSeekerConnectRequest Clone of current object.
     * @throws PropelException
     */
    ...
    public function initInformationSeekerConnectRequestCryosphereWheres($overrideExisting = true)
    {
        ...
        $this->collInformationSeekerConnectRequestCryosphereWheres->setModel('\InformationSeekerConnectRequestCryosphereWhere');
    }
