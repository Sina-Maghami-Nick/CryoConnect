 ...
 *
 * @method     \ExpertLanguagesQuery|\InformationSeekerConnectRequestLanguagesQuery|\InformationSeekerLanguagesQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class LanguagesQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'cryo_connect', $modelName = '\\Languages', $modelAlias = null)
    {
