...
class CryosphereWhatTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'CryoConnectDB.Map.CryosphereWhatTableMap';
     ...
     */
    const OM_CLASS = '\\CryoConnectDB\\CryosphereWhat';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'CryoConnectDB.CryosphereWhat';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\CryoConnectDB\\CryosphereWhat');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \CryoConnectDB\CryosphereWhat) { // it's a model object
