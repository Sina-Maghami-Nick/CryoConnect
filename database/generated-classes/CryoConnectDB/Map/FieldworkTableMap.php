...
class FieldworkTableMap extends TableMap
{
    ...
    /**
     * the column name for the fieldwork_duration field
     */
    const COL_FIELDWORK_DURATION = 'fieldwork.fieldwork_duration';
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(FieldworkTableMap::COL_FIELDWORK_DURATION);
            ...
            $criteria->addSelectColumn($alias . '.fieldwork_duration');
