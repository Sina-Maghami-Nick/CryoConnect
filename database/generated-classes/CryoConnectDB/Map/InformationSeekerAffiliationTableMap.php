...
use CryoConnectDB\InformationSeekerAffiliation;
use CryoConnectDB\InformationSeekerAffiliationQuery;
...
class InformationSeekerAffiliationTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'CryoConnectDB.Map.InformationSeekerAffiliationTableMap';
     ...
     */
    const OM_CLASS = '\\CryoConnectDB\\InformationSeekerAffiliation';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'CryoConnectDB.InformationSeekerAffiliation';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\CryoConnectDB\\InformationSeekerAffiliation');
