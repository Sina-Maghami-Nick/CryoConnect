...
class CountriesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'CryoConnectDB.Map.CountriesTableMap';
     ...
     */
    const OM_CLASS = '\\CryoConnectDB\\Countries';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'CryoConnectDB.Countries';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\CryoConnectDB\\Countries');
    ...
    {
        $this->addRelation('Experts', '\\CryoConnectDB\\Experts', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':country_code',
    1 => ':country_code',
        ...
        $this->addRelation('InformationSeekers', '\\CryoConnectDB\\InformationSeekers', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':country_code',
    1 => ':country_code',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \CryoConnectDB\Countries) { // it's a model object
