...
abstract class ExpertCryosphereMethodsQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'cryo_connect', $modelName = '\\CryoConnectDB\\ExpertCryosphereMethods', $modelAlias = null)
    {
    ...
    public function prune($expertCryosphereMethods = null)
    {
        if ($expertCryosphereMethods) {
            throw new LogicException('ExpertCryosphereMethods object has no primary key');
