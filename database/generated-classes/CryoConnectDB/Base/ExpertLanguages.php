...
/**
 * Base class that represents a row from the 'expert_languages' table.
 *
 *
 *
 * @package    propel.generator.CryoConnectDB.Base
 */
abstract class ExpertLanguages implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CryoConnectDB\\Map\\ExpertLanguagesTableMap';
    ...
    /**
     * Initializes internal state of CryoConnectDB\Base\ExpertLanguages object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>ExpertLanguages</code> instance.  If
     * <code>obj</code> is an instance of <code>ExpertLanguages</code>, delegates to
     * <code>equals(ExpertLanguages)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|ExpertLanguages The current object, for fluid interface
     */
     ...
     * @return $this|\CryoConnectDB\ExpertLanguages The current object (for fluent API support)
     */
    public function setExpertId($v)
    {
        ...
        if ($this->expert_id !== $v) {
            $this->expert_id = $v;
            $this->modifiedColumns[ExpertLanguagesTableMap::COL_EXPERT_ID] = true;
        }
    ...
    public function setLanguageCode($v)
    {
        ...
        if ($this->language_code !== $v) {
            ...
            $this->modifiedColumns[ExpertLanguagesTableMap::COL_LANGUAGE_CODE] = true;
        }
    ...
    public function setTimestamp($v)
    {
        ...
        if ($this->timestamp !== null || $dt !== null) {
            if ($this->timestamp === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->timestamp->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ExpertLanguagesTableMap::COL_TIMESTAMP] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ExpertLanguagesTableMap::translateFieldName('ExpertId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->expert_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ExpertLanguagesTableMap::translateFieldName('LanguageCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->language_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ExpertLanguagesTableMap::translateFieldName('Timestamp', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = ExpertLanguagesTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CryoConnectDB\\ExpertLanguages'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildExpertLanguagesQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ExpertLanguages::setDeleted()
     * @see ExpertLanguages::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildExpertLanguagesQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ExpertLanguagesTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ExpertLanguagesTableMap::COL_EXPERT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'expert_id';
        }
        if ($this->isColumnModified(ExpertLanguagesTableMap::COL_LANGUAGE_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'language_code';
        }
        if ($this->isColumnModified(ExpertLanguagesTableMap::COL_TIMESTAMP)) {
            $modifiedColumns[':p' . $index++]  = 'timestamp';
        }

        $sql = sprintf(
            'INSERT INTO expert_languages (%s) VALUES (%s)',
    ...
    {
        $pos = ExpertLanguagesTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['ExpertLanguages'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ExpertLanguages'][$this->hashCode()] = true;
        $keys = ExpertLanguagesTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CryoConnectDB\ExpertLanguages
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CryoConnectDB\ExpertLanguages The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ExpertLanguagesTableMap::COL_EXPERT_ID)) {
            $criteria->add(ExpertLanguagesTableMap::COL_EXPERT_ID, $this->expert_id);
        }
        if ($this->isColumnModified(ExpertLanguagesTableMap::COL_LANGUAGE_CODE)) {
            $criteria->add(ExpertLanguagesTableMap::COL_LANGUAGE_CODE, $this->language_code);
        }
        if ($this->isColumnModified(ExpertLanguagesTableMap::COL_TIMESTAMP)) {
            $criteria->add(ExpertLanguagesTableMap::COL_TIMESTAMP, $this->timestamp);
        }
    ...
    {
        $criteria = ChildExpertLanguagesQuery::create();
        $criteria->add(ExpertLanguagesTableMap::COL_EXPERT_ID, $this->expert_id);
        $criteria->add(ExpertLanguagesTableMap::COL_LANGUAGE_CODE, $this->language_code);
    ...
    public function hashCode()
    {
        ...
        //relation expert_languages_fk_023b7c to table experts
        ...
        //relation expert_languages_fk_0fb9dd to table languages
    ...
    {
        return (null === $this->getExpertId()) && (null === $this->getLanguageCode());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CryoConnectDB\ExpertLanguages (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CryoConnectDB\ExpertLanguages Clone of current object.
     * @throws PropelException
     */
    ...
    public function getExperts(ConnectionInterface $con = null)
    {
        if ($this->aExperts === null && ($this->expert_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aExperts->addExpertLanguagess($this);
             */
        }
    ...
    public function getLanguages(ConnectionInterface $con = null)
    {
        if ($this->aLanguages === null && (($this->language_code !== "" && $this->language_code !== null))) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aLanguages->addExpertLanguagess($this);
             */
        }
    ...
    {
        if (null !== $this->aExperts) {
            $this->aExperts->removeExpertLanguages($this);
        }
        if (null !== $this->aLanguages) {
            $this->aLanguages->removeExpertLanguages($this);
        }
        $this->expert_id = null;
    ...
    {
        return (string) $this->exportTo(ExpertLanguagesTableMap::DEFAULT_STRING_FORMAT);
    }
