...
/**
 * Base class that represents a row from the 'information_seeker_languages' table.
 *
 *
 *
 * @package    propel.generator.CryoConnectDB.Base
 */
abstract class InformationSeekerLanguages implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CryoConnectDB\\Map\\InformationSeekerLanguagesTableMap';
    ...
    /**
     * Initializes internal state of CryoConnectDB\Base\InformationSeekerLanguages object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>InformationSeekerLanguages</code> instance.  If
     * <code>obj</code> is an instance of <code>InformationSeekerLanguages</code>, delegates to
     * <code>equals(InformationSeekerLanguages)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|InformationSeekerLanguages The current object, for fluid interface
     */
     ...
     * @return $this|\CryoConnectDB\InformationSeekerLanguages The current object (for fluent API support)
     */
    public function setInformationSeekerId($v)
    {
        ...
        if ($this->information_seeker_id !== $v) {
            ...
            $this->modifiedColumns[InformationSeekerLanguagesTableMap::COL_INFORMATION_SEEKER_ID] = true;
        }
    ...
    public function setLanguageCode($v)
    {
        ...
        if ($this->language_code !== $v) {
            ...
            $this->modifiedColumns[InformationSeekerLanguagesTableMap::COL_LANGUAGE_CODE] = true;
        }
    ...
    public function setTimestamp($v)
    {
        ...
        if ($this->timestamp !== null || $dt !== null) {
            if ($this->timestamp === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->timestamp->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[InformationSeekerLanguagesTableMap::COL_TIMESTAMP] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : InformationSeekerLanguagesTableMap::translateFieldName('InformationSeekerId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->information_seeker_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : InformationSeekerLanguagesTableMap::translateFieldName('LanguageCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->language_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : InformationSeekerLanguagesTableMap::translateFieldName('Timestamp', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = InformationSeekerLanguagesTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CryoConnectDB\\InformationSeekerLanguages'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildInformationSeekerLanguagesQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see InformationSeekerLanguages::setDeleted()
     * @see InformationSeekerLanguages::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildInformationSeekerLanguagesQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                InformationSeekerLanguagesTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(InformationSeekerLanguagesTableMap::COL_INFORMATION_SEEKER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'Information_seeker_id';
        }
        if ($this->isColumnModified(InformationSeekerLanguagesTableMap::COL_LANGUAGE_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'language_code';
        }
        if ($this->isColumnModified(InformationSeekerLanguagesTableMap::COL_TIMESTAMP)) {
            $modifiedColumns[':p' . $index++]  = 'timestamp';
        }

        $sql = sprintf(
            'INSERT INTO information_seeker_languages (%s) VALUES (%s)',
    ...
    {
        $pos = InformationSeekerLanguagesTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['InformationSeekerLanguages'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['InformationSeekerLanguages'][$this->hashCode()] = true;
        $keys = InformationSeekerLanguagesTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getInformationSeekerId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CryoConnectDB\InformationSeekerLanguages
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setInformationSeekerId($arr[$keys[0]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CryoConnectDB\InformationSeekerLanguages The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(InformationSeekerLanguagesTableMap::COL_INFORMATION_SEEKER_ID)) {
            $criteria->add(InformationSeekerLanguagesTableMap::COL_INFORMATION_SEEKER_ID, $this->information_seeker_id);
        }
        if ($this->isColumnModified(InformationSeekerLanguagesTableMap::COL_LANGUAGE_CODE)) {
            $criteria->add(InformationSeekerLanguagesTableMap::COL_LANGUAGE_CODE, $this->language_code);
        }
        if ($this->isColumnModified(InformationSeekerLanguagesTableMap::COL_TIMESTAMP)) {
            $criteria->add(InformationSeekerLanguagesTableMap::COL_TIMESTAMP, $this->timestamp);
        }
    ...
    {
        $criteria = ChildInformationSeekerLanguagesQuery::create();
        $criteria->add(InformationSeekerLanguagesTableMap::COL_INFORMATION_SEEKER_ID, $this->information_seeker_id);
        $criteria->add(InformationSeekerLanguagesTableMap::COL_LANGUAGE_CODE, $this->language_code);
    ...
    {
        $validPk = null !== $this->getInformationSeekerId() &&
            null !== $this->getLanguageCode();

        $validPrimaryKeyFKs = 2;
        $primaryKeyFKs = [];

        //relation information_seeker_languages_ibfk_1 to table information_seekers
        ...
        //relation information_seeker_languages_fk_0fb9dd to table languages
    ...
    {
        $pks = array();
        $pks[0] = $this->getInformationSeekerId();
    ...
    {
        $this->setInformationSeekerId($keys[0]);
    ...
    {
        return (null === $this->getInformationSeekerId()) && (null === $this->getLanguageCode());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CryoConnectDB\InformationSeekerLanguages (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CryoConnectDB\InformationSeekerLanguages Clone of current object.
     * @throws PropelException
     */
    ...
    public function setInformationSeekers(ChildInformationSeekers $v = null)
    {
        ...
        if ($v !== null) {
            $v->addInformationSeekerLanguages($this);
        }
    ...
    public function getInformationSeekers(ConnectionInterface $con = null)
    {
        if ($this->aInformationSeekers === null && ($this->information_seeker_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aInformationSeekers->addInformationSeekerLanguagess($this);
             */
        }
    ...
    public function getLanguages(ConnectionInterface $con = null)
    {
        if ($this->aLanguages === null && (($this->language_code !== "" && $this->language_code !== null))) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aLanguages->addInformationSeekerLanguagess($this);
             */
        }
    ...
    {
        if (null !== $this->aInformationSeekers) {
            $this->aInformationSeekers->removeInformationSeekerLanguages($this);
        }
        if (null !== $this->aLanguages) {
            $this->aLanguages->removeInformationSeekerLanguages($this);
        }
    ...
    {
        return (string) $this->exportTo(InformationSeekerLanguagesTableMap::DEFAULT_STRING_FORMAT);
    }
