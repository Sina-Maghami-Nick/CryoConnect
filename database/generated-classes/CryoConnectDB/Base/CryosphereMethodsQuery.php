...
abstract class CryosphereMethodsQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \CryoConnectDB\Base\CryosphereMethodsQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'cryo_connect', $modelName = '\\CryoConnectDB\\CryosphereMethods', $modelAlias = null)
    {
