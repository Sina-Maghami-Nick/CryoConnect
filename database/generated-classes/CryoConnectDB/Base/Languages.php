...
abstract class Languages implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\CryoConnectDB\\Map\\LanguagesTableMap';
    ...
    /**
     * Initializes internal state of CryoConnectDB\Base\Languages object.
     */
     ...
     * @return $this|\CryoConnectDB\Languages The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\CryoConnectDB\\Languages'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CryoConnectDB\Languages
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CryoConnectDB\Languages The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CryoConnectDB\Languages (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CryoConnectDB\Languages Clone of current object.
     * @throws PropelException
     */
