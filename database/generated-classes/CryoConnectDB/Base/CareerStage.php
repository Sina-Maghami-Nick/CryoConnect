...
/**
 * Base class that represents a row from the 'career_stage' table.
 *
 *
 *
 * @package    propel.generator.CryoConnectDB.Base
 */
abstract class CareerStage implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CryoConnectDB\\Map\\CareerStageTableMap';
    ...
    /**
     * The value for the career_stage_name field.
     *
     * @var        string
     */
    protected $career_stage_name;
    ...
    /**
     * Initializes internal state of CryoConnectDB\Base\CareerStage object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>CareerStage</code> instance.  If
     * <code>obj</code> is an instance of <code>CareerStage</code>, delegates to
     * <code>equals(CareerStage)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|CareerStage The current object, for fluid interface
     */
    ...
    /**
     * Get the [career_stage_name] column value.
     *
     * @return string
     */
    public function getCareerStageName()
    {
        return $this->career_stage_name;
    }
     ...
     * @return $this|\CryoConnectDB\CareerStage The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[CareerStageTableMap::COL_ID] = true;
        }
    ...
    /**
     * Set the value of [career_stage_name] column.
     *
     * @param string $v new value
     * @return $this|\CryoConnectDB\CareerStage The current object (for fluent API support)
     */
    public function setCareerStageName($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->career_stage_name !== $v) {
            $this->career_stage_name = $v;
            $this->modifiedColumns[CareerStageTableMap::COL_CAREER_STAGE_NAME] = true;
        }
    ...
    public function setTimestamp($v)
    {
        ...
        if ($this->timestamp !== null || $dt !== null) {
            if ($this->timestamp === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->timestamp->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[CareerStageTableMap::COL_TIMESTAMP] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CareerStageTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CareerStageTableMap::translateFieldName('CareerStageName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->career_stage_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CareerStageTableMap::translateFieldName('Timestamp', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = CareerStageTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CryoConnectDB\\CareerStage'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCareerStageQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CareerStage::setDeleted()
     * @see CareerStage::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCareerStageQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CareerStageTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[CareerStageTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . CareerStageTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(CareerStageTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(CareerStageTableMap::COL_CAREER_STAGE_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'career_stage_name';
        }
        if ($this->isColumnModified(CareerStageTableMap::COL_TIMESTAMP)) {
            $modifiedColumns[':p' . $index++]  = 'timestamp';
        }

        $sql = sprintf(
            'INSERT INTO career_stage (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id':
                        ...
                        break;
                    case 'career_stage_name':
                        $stmt->bindValue($identifier, $this->career_stage_name, PDO::PARAM_STR);
                        break;
                    case 'timestamp':
    ...
    {
        $pos = CareerStageTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                return $this->getCareerStageName();
                break;
            case 2:
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['CareerStage'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CareerStage'][$this->hashCode()] = true;
        $keys = CareerStageTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getCareerStageName(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CryoConnectDB\CareerStage
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setCareerStageName($arr[$keys[1]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CryoConnectDB\CareerStage The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(CareerStageTableMap::DATABASE_NAME);

        if ($this->isColumnModified(CareerStageTableMap::COL_ID)) {
            $criteria->add(CareerStageTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(CareerStageTableMap::COL_CAREER_STAGE_NAME)) {
            $criteria->add(CareerStageTableMap::COL_CAREER_STAGE_NAME, $this->career_stage_name);
        }
        if ($this->isColumnModified(CareerStageTableMap::COL_TIMESTAMP)) {
            $criteria->add(CareerStageTableMap::COL_TIMESTAMP, $this->timestamp);
        }
    ...
    {
        $criteria = ChildCareerStageQuery::create();
        $criteria->add(CareerStageTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CryoConnectDB\CareerStage (or compatible) type.
    ...
    {
        $copyObj->setCareerStageName($this->getCareerStageName());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CryoConnectDB\CareerStage Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildCareerStage is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildCareerStage The current object (for fluent API support)
     */
    public function setExpertCareerStages(Collection $expertCareerStages, ConnectionInterface $con = null)
    {
        ...
        foreach ($expertCareerStagesToDelete as $expertCareerStageRemoved) {
            $expertCareerStageRemoved->setCareerStage(null);
        }
    ...
    protected function doAddExpertCareerStage(ChildExpertCareerStage $expertCareerStage)
    {
        ...
        $expertCareerStage->setCareerStage($this);
    }
    ...
    public function removeExpertCareerStage(ChildExpertCareerStage $expertCareerStage)
    {
        if ($this->getExpertCareerStages()->contains($expertCareerStage)) {
            ...
            $expertCareerStage->setCareerStage(null);
        }
     ...
     * Otherwise if this CareerStage is new, it will return
     * an empty collection; or if this CareerStage has previously
     * been saved, it will retrieve related ExpertCareerStages from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in CareerStage.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildExpertCareerStage[] List of ChildExpertCareerStage objects
     */
    public function getExpertCareerStagesJoinExperts(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildExpertCareerStageQuery::create(null, $criteria);
     ...
     * @return ChildCareerStage The current object (for fluent API support)
     */
    ...
    protected function doAddExperts(ChildExperts $experts)
    {
        ...
        $expertCareerStage->setExperts($experts);
        ...
        if (!$experts->isCareerStagesLoaded()) {
            $experts->initCareerStages();
            $experts->getCareerStages()->push($this);
        } elseif (!$experts->getCareerStages()->contains($this)) {
            $experts->getCareerStages()->push($this);
        }
    ...
    public function removeExperts(ChildExperts $experts)
    {
        if ($this->getExpertss()->contains($experts)) {
            ...
            if ($experts->isCareerStagesLoaded()) {
                ...
                $experts->getCareerStages()->removeObject($this);
            }
    ...
    {
        return (string) $this->exportTo(CareerStageTableMap::DEFAULT_STRING_FORMAT);
    }
