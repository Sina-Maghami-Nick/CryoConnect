 ...
 *
 * @method     \CryoConnectDB\ExpertsQuery|\CryoConnectDB\InformationSeekersQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class CountriesQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \CryoConnectDB\Base\CountriesQuery object.
     *
     ...
     *
     * @param \CryoConnectDB\Experts|ObjectCollection $experts the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     ...
     *
     * @param \CryoConnectDB\InformationSeekers|ObjectCollection $informationSeekers the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildCountriesQuery The current query, for fluid interface
     */
