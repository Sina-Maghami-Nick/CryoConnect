...
/**
 * Base class that represents a row from the 'cryosphere_methods' table.
 *
 *
 *
 * @package    propel.generator.CryoConnectDB.Base
 */
abstract class CryosphereMethods implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CryoConnectDB\\Map\\CryosphereMethodsTableMap';
    ...
    /**
     * The value for the cryosphere_methods_name field.
     *
     * @var        string
     */
    ...
    /**
     * Initializes internal state of CryoConnectDB\Base\CryosphereMethods object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>CryosphereMethods</code> instance.  If
     * <code>obj</code> is an instance of <code>CryosphereMethods</code>, delegates to
     * <code>equals(CryosphereMethods)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|CryosphereMethods The current object, for fluid interface
     */
    ...
    /**
     * Get the [cryosphere_methods_name] column value.
     *
     * @return string
     */
    public function getCryosphereMethodsName()
    {
        return $this->cryosphere_methods_name;
    }
    ...
    /**
     * Set the value of [cryosphere_methods_name] column.
     *
     * @param string $v new value
     * @return $this|\CryoConnectDB\CryosphereMethods The current object (for fluent API support)
     */
    public function setCryosphereMethodsName($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->cryosphere_methods_name !== $v) {
            $this->cryosphere_methods_name = $v;
            $this->modifiedColumns[CryosphereMethodsTableMap::COL_CRYOSPHERE_METHODS_NAME] = true;
        }
    ...
    public function setTimestamp($v)
    {
        ...
        if ($this->timestamp !== null || $dt !== null) {
            if ($this->timestamp === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->timestamp->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[CryosphereMethodsTableMap::COL_TIMESTAMP] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CryosphereMethodsTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCryosphereMethodsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CryosphereMethods::setDeleted()
     * @see CryosphereMethods::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCryosphereMethodsQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CryosphereMethodsTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO cryosphere_methods (%s) VALUES (%s)',
    ...
    {
        $pos = CryosphereMethodsTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['CryosphereMethods'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CryosphereMethods'][$this->hashCode()] = true;
        $keys = CryosphereMethodsTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CryoConnectDB\CryosphereMethods
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CryoConnectDB\CryosphereMethods The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CryosphereMethodsTableMap::COL_ID)) {
            $criteria->add(CryosphereMethodsTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(CryosphereMethodsTableMap::COL_CRYOSPHERE_METHODS_NAME)) {
    ...
    {
        $criteria = ChildCryosphereMethodsQuery::create();
        $criteria->add(CryosphereMethodsTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CryoConnectDB\CryosphereMethods (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CryoConnectDB\CryosphereMethods Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildCryosphereMethods is new, it will return
     ...
     * actually need in CryosphereMethods.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ChildCryosphereMethods The current object (for fluent API support)
     */
    ...
    protected function doAddExperts(ChildExperts $experts)
    {
        ...
        $expertCryosphereMethods->setExperts($experts);
        ...
        if (!$experts->isCryosphereMethodssLoaded()) {
            $experts->initCryosphereMethodss();
            $experts->getCryosphereMethodss()->push($this);
        } elseif (!$experts->getCryosphereMethodss()->contains($this)) {
            $experts->getCryosphereMethodss()->push($this);
        }
    ...
    public function removeExperts(ChildExperts $experts)
    {
        if ($this->getExpertss()->contains($experts)) {
            ...
            if ($experts->isCryosphereMethodssLoaded()) {
                ...
                $experts->getCryosphereMethodss()->removeObject($this);
            }
    ...
    {
        return (string) $this->exportTo(CryosphereMethodsTableMap::DEFAULT_STRING_FORMAT);
    }
