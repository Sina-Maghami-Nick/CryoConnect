...
/**
 * Base class that represents a row from the 'information_seeker_connect_request_languages' table.
 *
 *
 *
 * @package    propel.generator.CryoConnectDB.Base
 */
abstract class InformationSeekerConnectRequestLanguages implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CryoConnectDB\\Map\\InformationSeekerConnectRequestLanguagesTableMap';
    ...
    {
        $this->timestamp = PropelDateTime::newInstance(NULL, null, 'DateTime');
    }

    /**
     * Initializes internal state of CryoConnectDB\Base\InformationSeekerConnectRequestLanguages object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>InformationSeekerConnectRequestLanguages</code> instance.  If
     * <code>obj</code> is an instance of <code>InformationSeekerConnectRequestLanguages</code>, delegates to
     * <code>equals(InformationSeekerConnectRequestLanguages)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|InformationSeekerConnectRequestLanguages The current object, for fluid interface
     */
     ...
     * @return $this|\CryoConnectDB\InformationSeekerConnectRequestLanguages The current object (for fluent API support)
     */
    public function setInformationSeekerConnectRequestId($v)
    {
        ...
        if ($this->information_seeker_connect_request_id !== $v) {
            ...
            $this->modifiedColumns[InformationSeekerConnectRequestLanguagesTableMap::COL_INFORMATION_SEEKER_CONNECT_REQUEST_ID] = true;
        }
    ...
    public function setLanguageCode($v)
    {
        ...
        if ($this->language_code !== $v) {
            ...
            $this->modifiedColumns[InformationSeekerConnectRequestLanguagesTableMap::COL_LANGUAGE_CODE] = true;
        }

        if ($this->aLanguages !== null && $this->aLanguages->getLanguageCode() !== $v) {
    ...
    public function setTimestamp($v)
    {
        ...
        if ($this->timestamp !== null || $dt !== null) {
            if ( ($dt != $this->timestamp) // normalized values don't match
                || ($dt->format('Y-m-d H:i:s.u') === NULL) // or the entered value matches the default
                 ) {
                $this->timestamp = $dt === null ? null : clone $dt;
                $this->modifiedColumns[InformationSeekerConnectRequestLanguagesTableMap::COL_TIMESTAMP] = true;
            }
    ...
    {
            if ($this->timestamp && $this->timestamp->format('Y-m-d H:i:s.u') !== NULL) {
                return false;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : InformationSeekerConnectRequestLanguagesTableMap::translateFieldName('InformationSeekerConnectRequestId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->information_seeker_connect_request_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : InformationSeekerConnectRequestLanguagesTableMap::translateFieldName('LanguageCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->language_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : InformationSeekerConnectRequestLanguagesTableMap::translateFieldName('Timestamp', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = InformationSeekerConnectRequestLanguagesTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CryoConnectDB\\InformationSeekerConnectRequestLanguages'), 0, $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aLanguages !== null && $this->language_code !== $this->aLanguages->getLanguageCode()) {
            $this->aLanguages = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildInformationSeekerConnectRequestLanguagesQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see InformationSeekerConnectRequestLanguages::setDeleted()
     * @see InformationSeekerConnectRequestLanguages::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildInformationSeekerConnectRequestLanguagesQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                InformationSeekerConnectRequestLanguagesTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(InformationSeekerConnectRequestLanguagesTableMap::COL_INFORMATION_SEEKER_CONNECT_REQUEST_ID)) {
            $modifiedColumns[':p' . $index++]  = 'information_seeker_connect_request_id';
        }
        if ($this->isColumnModified(InformationSeekerConnectRequestLanguagesTableMap::COL_LANGUAGE_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'language_code';
        }
        if ($this->isColumnModified(InformationSeekerConnectRequestLanguagesTableMap::COL_TIMESTAMP)) {
            $modifiedColumns[':p' . $index++]  = 'timestamp';
        }

        $sql = sprintf(
            'INSERT INTO information_seeker_connect_request_languages (%s) VALUES (%s)',
    ...
    {
        $pos = InformationSeekerConnectRequestLanguagesTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['InformationSeekerConnectRequestLanguages'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['InformationSeekerConnectRequestLanguages'][$this->hashCode()] = true;
        $keys = InformationSeekerConnectRequestLanguagesTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getInformationSeekerConnectRequestId(),
            $keys[1] => $this->getLanguageCode(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CryoConnectDB\InformationSeekerConnectRequestLanguages
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setLanguageCode($arr[$keys[1]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CryoConnectDB\InformationSeekerConnectRequestLanguages The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(InformationSeekerConnectRequestLanguagesTableMap::COL_INFORMATION_SEEKER_CONNECT_REQUEST_ID)) {
            $criteria->add(InformationSeekerConnectRequestLanguagesTableMap::COL_INFORMATION_SEEKER_CONNECT_REQUEST_ID, $this->information_seeker_connect_request_id);
        }
        if ($this->isColumnModified(InformationSeekerConnectRequestLanguagesTableMap::COL_LANGUAGE_CODE)) {
            $criteria->add(InformationSeekerConnectRequestLanguagesTableMap::COL_LANGUAGE_CODE, $this->language_code);
        }
        if ($this->isColumnModified(InformationSeekerConnectRequestLanguagesTableMap::COL_TIMESTAMP)) {
            $criteria->add(InformationSeekerConnectRequestLanguagesTableMap::COL_TIMESTAMP, $this->timestamp);
        }
    ...
    {
        $criteria = ChildInformationSeekerConnectRequestLanguagesQuery::create();
        $criteria->add(InformationSeekerConnectRequestLanguagesTableMap::COL_INFORMATION_SEEKER_CONNECT_REQUEST_ID, $this->information_seeker_connect_request_id);
        $criteria->add(InformationSeekerConnectRequestLanguagesTableMap::COL_LANGUAGE_CODE, $this->language_code);
    ...
    public function hashCode()
    {
        $validPk = null !== $this->getInformationSeekerConnectRequestId() &&
            null !== $this->getLanguageCode();

        $validPrimaryKeyFKs = 2;
        $primaryKeyFKs = [];

        //relation information_seeker_connect_request_languages_fk_185361 to table information_seeker_connect_request
        ...
        //relation information_seeker_connect_request_languages_fk_0fb9dd to table languages
        if ($this->aLanguages && $hash = spl_object_hash($this->aLanguages)) {
            $primaryKeyFKs[] = $hash;
        } else {
            $validPrimaryKeyFKs = false;
        }
    ...
    {
        return (null === $this->getInformationSeekerConnectRequestId()) && (null === $this->getLanguageCode());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CryoConnectDB\InformationSeekerConnectRequestLanguages (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CryoConnectDB\InformationSeekerConnectRequestLanguages Clone of current object.
     * @throws PropelException
     */
    ...
    public function setInformationSeekerConnectRequest(ChildInformationSeekerConnectRequest $v = null)
    {
        ...
        if ($v !== null) {
            $v->addInformationSeekerConnectRequestLanguages($this);
        }
    ...
    public function getInformationSeekerConnectRequest(ConnectionInterface $con = null)
    {
        if ($this->aInformationSeekerConnectRequest === null && ($this->information_seeker_connect_request_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aInformationSeekerConnectRequest->addInformationSeekerConnectRequestLanguagess($this);
             */
        }
    ...
    public function setLanguages(ChildLanguages $v = null)
    {
        if ($v === null) {
            ...
            $this->setLanguageCode($v->getLanguageCode());
        }
    ...
    {
        if ($this->aLanguages === null && (($this->language_code !== "" && $this->language_code !== null))) {
            $this->aLanguages = ChildLanguagesQuery::create()->findPk($this->language_code, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aLanguages->addInformationSeekerConnectRequestLanguagess($this);
             */
        }
    ...
    {
        if (null !== $this->aInformationSeekerConnectRequest) {
            $this->aInformationSeekerConnectRequest->removeInformationSeekerConnectRequestLanguages($this);
        }
        if (null !== $this->aLanguages) {
            $this->aLanguages->removeInformationSeekerConnectRequestLanguages($this);
        }
    ...
    {
        return (string) $this->exportTo(InformationSeekerConnectRequestLanguagesTableMap::DEFAULT_STRING_FORMAT);
    }
