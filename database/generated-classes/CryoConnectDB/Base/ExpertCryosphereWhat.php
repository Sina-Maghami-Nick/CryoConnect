...
/**
 * Base class that represents a row from the 'expert_cryosphere_what' table.
 *
 *
 *
 * @package    propel.generator.CryoConnectDB.Base
 */
abstract class ExpertCryosphereWhat implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CryoConnectDB\\Map\\ExpertCryosphereWhatTableMap';
    ...
    /**
     * Initializes internal state of CryoConnectDB\Base\ExpertCryosphereWhat object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>ExpertCryosphereWhat</code> instance.  If
     * <code>obj</code> is an instance of <code>ExpertCryosphereWhat</code>, delegates to
     * <code>equals(ExpertCryosphereWhat)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|ExpertCryosphereWhat The current object, for fluid interface
     */
     ...
     * @return $this|\CryoConnectDB\ExpertCryosphereWhat The current object (for fluent API support)
     */
    public function setExpertId($v)
    {
        ...
        if ($this->expert_id !== $v) {
            $this->expert_id = $v;
            $this->modifiedColumns[ExpertCryosphereWhatTableMap::COL_EXPERT_ID] = true;
        }
    ...
    public function setCryosphereWhatId($v)
    {
        ...
        if ($this->cryosphere_what_id !== $v) {
            ...
            $this->modifiedColumns[ExpertCryosphereWhatTableMap::COL_CRYOSPHERE_WHAT_ID] = true;
        }
    ...
    public function setTimestamp($v)
    {
        ...
        if ($this->timestamp !== null || $dt !== null) {
            if ($this->timestamp === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->timestamp->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ExpertCryosphereWhatTableMap::COL_TIMESTAMP] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ExpertCryosphereWhatTableMap::translateFieldName('ExpertId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->expert_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ExpertCryosphereWhatTableMap::translateFieldName('CryosphereWhatId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cryosphere_what_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ExpertCryosphereWhatTableMap::translateFieldName('Timestamp', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = ExpertCryosphereWhatTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CryoConnectDB\\ExpertCryosphereWhat'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildExpertCryosphereWhatQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ExpertCryosphereWhat::setDeleted()
     * @see ExpertCryosphereWhat::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildExpertCryosphereWhatQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ExpertCryosphereWhatTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ExpertCryosphereWhatTableMap::COL_EXPERT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'expert_id';
        }
        if ($this->isColumnModified(ExpertCryosphereWhatTableMap::COL_CRYOSPHERE_WHAT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'cryosphere_what_id';
        }
        if ($this->isColumnModified(ExpertCryosphereWhatTableMap::COL_TIMESTAMP)) {
            $modifiedColumns[':p' . $index++]  = 'timestamp';
        }

        $sql = sprintf(
            'INSERT INTO expert_cryosphere_what (%s) VALUES (%s)',
    ...
    {
        $pos = ExpertCryosphereWhatTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['ExpertCryosphereWhat'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ExpertCryosphereWhat'][$this->hashCode()] = true;
        $keys = ExpertCryosphereWhatTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CryoConnectDB\ExpertCryosphereWhat
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CryoConnectDB\ExpertCryosphereWhat The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ExpertCryosphereWhatTableMap::COL_EXPERT_ID)) {
            $criteria->add(ExpertCryosphereWhatTableMap::COL_EXPERT_ID, $this->expert_id);
        }
        if ($this->isColumnModified(ExpertCryosphereWhatTableMap::COL_CRYOSPHERE_WHAT_ID)) {
            $criteria->add(ExpertCryosphereWhatTableMap::COL_CRYOSPHERE_WHAT_ID, $this->cryosphere_what_id);
        }
        if ($this->isColumnModified(ExpertCryosphereWhatTableMap::COL_TIMESTAMP)) {
            $criteria->add(ExpertCryosphereWhatTableMap::COL_TIMESTAMP, $this->timestamp);
        }
    ...
    {
        $criteria = ChildExpertCryosphereWhatQuery::create();
        $criteria->add(ExpertCryosphereWhatTableMap::COL_EXPERT_ID, $this->expert_id);
        $criteria->add(ExpertCryosphereWhatTableMap::COL_CRYOSPHERE_WHAT_ID, $this->cryosphere_what_id);
    ...
    public function hashCode()
    {
        ...
        //relation expert_cryosphere_what_fk_023b7c to table experts
        ...
        //relation expert_cryosphere_what_fk_e45748 to table cryosphere_what
    ...
    {
        return (null === $this->getExpertId()) && (null === $this->getCryosphereWhatId());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CryoConnectDB\ExpertCryosphereWhat (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CryoConnectDB\ExpertCryosphereWhat Clone of current object.
     * @throws PropelException
     */
    ...
    public function setExperts(ChildExperts $v = null)
    {
        ...
        if ($v !== null) {
            $v->addExpertCryosphereWhat($this);
        }
    ...
    public function getExperts(ConnectionInterface $con = null)
    {
        if ($this->aExperts === null && ($this->expert_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aExperts->addExpertCryosphereWhats($this);
             */
        }
    ...
    public function getCryosphereWhat(ConnectionInterface $con = null)
    {
        if ($this->aCryosphereWhat === null && ($this->cryosphere_what_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCryosphereWhat->addExpertCryosphereWhats($this);
             */
        }
    ...
    {
        if (null !== $this->aExperts) {
            $this->aExperts->removeExpertCryosphereWhat($this);
        }
        if (null !== $this->aCryosphereWhat) {
            $this->aCryosphereWhat->removeExpertCryosphereWhat($this);
        }
        $this->expert_id = null;
    ...
    {
        return (string) $this->exportTo(ExpertCryosphereWhatTableMap::DEFAULT_STRING_FORMAT);
    }
