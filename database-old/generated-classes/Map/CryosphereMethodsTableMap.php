...
use \CryosphereMethods;
use \CryosphereMethodsQuery;
...
class CryosphereMethodsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.CryosphereMethodsTableMap';
     ...
     */
    const OM_CLASS = '\\CryosphereMethods';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'CryosphereMethods';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\CryosphereMethods');
        $this->setPackage('');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \CryosphereMethods) { // it's a model object
