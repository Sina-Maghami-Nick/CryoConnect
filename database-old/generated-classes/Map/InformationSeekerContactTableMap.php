...
use \InformationSeekerContact;
use \InformationSeekerContactQuery;
...
class InformationSeekerContactTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.InformationSeekerContactTableMap';
     ...
     */
    const OM_CLASS = '\\InformationSeekerContact';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'InformationSeekerContact';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\InformationSeekerContact');
        $this->setPackage('');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \InformationSeekerContact) { // it's a model object
