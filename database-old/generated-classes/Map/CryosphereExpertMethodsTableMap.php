...
use \CryosphereExpertMethods;
use \CryosphereExpertMethodsQuery;
...
class CryosphereExpertMethodsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.CryosphereExpertMethodsTableMap';
     ...
     */
    const OM_CLASS = '\\CryosphereExpertMethods';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'CryosphereExpertMethods';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\CryosphereExpertMethods');
        $this->setPackage('');
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('CryosphereMethods', '\\CryosphereMethods', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':method_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \CryosphereExpertMethods) { // it's a model object
