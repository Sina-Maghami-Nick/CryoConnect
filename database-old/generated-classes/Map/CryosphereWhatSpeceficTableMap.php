...
use \CryosphereWhatSpecefic;
use \CryosphereWhatSpeceficQuery;
...
class CryosphereWhatSpeceficTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.CryosphereWhatSpeceficTableMap';
     ...
     */
    const OM_CLASS = '\\CryosphereWhatSpecefic';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'CryosphereWhatSpecefic';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'CryosphereWhatSpeceficName', 'Timestamp', ),
        self::TYPE_CAMELNAME     => array('id', 'cryosphereWhatSpeceficName', 'timestamp', ),
        self::TYPE_COLNAME       => array(CryosphereWhatSpeceficTableMap::COL_ID, CryosphereWhatSpeceficTableMap::COL_CRYOSPHERE_WHAT_SPECEFIC_NAME, CryosphereWhatSpeceficTableMap::COL_TIMESTAMP, ),
        self::TYPE_FIELDNAME     => array('id', 'cryosphere_what_specefic_name', 'timestamp', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'CryosphereWhatSpeceficName' => 1, 'Timestamp' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'cryosphereWhatSpeceficName' => 1, 'timestamp' => 2, ),
        self::TYPE_COLNAME       => array(CryosphereWhatSpeceficTableMap::COL_ID => 0, CryosphereWhatSpeceficTableMap::COL_CRYOSPHERE_WHAT_SPECEFIC_NAME => 1, CryosphereWhatSpeceficTableMap::COL_TIMESTAMP => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'cryosphere_what_specefic_name' => 1, 'timestamp' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\CryosphereWhatSpecefic');
        $this->setPackage('');
    ...
    {
        $this->addRelation('ExpertCryosphereWhatSpecefic', '\\ExpertCryosphereWhatSpecefic', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \CryosphereWhatSpecefic) { // it's a model object
