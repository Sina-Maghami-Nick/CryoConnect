...
use \ExpertAffiliation;
use \ExpertAffiliationQuery;
...
class ExpertAffiliationTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.ExpertAffiliationTableMap';
     ...
     */
    const OM_CLASS = '\\ExpertAffiliation';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'ExpertAffiliation';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\ExpertAffiliation');
        $this->setPackage('');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \ExpertAffiliation) { // it's a model object
