...
abstract class InformationSeekerAffiliation implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\InformationSeekerAffiliationTableMap';
    ...
    /**
     * Initializes internal state of Base\InformationSeekerAffiliation object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\InformationSeekerAffiliation The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\InformationSeekerAffiliation'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\InformationSeekerAffiliation
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \InformationSeekerAffiliation (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \InformationSeekerAffiliation Clone of current object.
     * @throws PropelException
     */
