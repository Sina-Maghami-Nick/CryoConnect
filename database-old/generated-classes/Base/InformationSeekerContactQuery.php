 ...
 *
 * @method     \InformationSeekersQuery|\ContactTypesQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class InformationSeekerContactQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\InformationSeekerContactQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'cryo_connect', $modelName = '\\InformationSeekerContact', $modelAlias = null)
    {
     ...
     *
     * @param \ContactTypes|ObjectCollection $contactTypes The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    public function filterByContactTypes($contactTypes, $comparison = null)
    {
        if ($contactTypes instanceof \ContactTypes) {
            ...
            throw new PropelException('filterByContactTypes() only accepts arguments of type \ContactTypes or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \ContactTypesQuery A secondary query class using the current class as primary query
     */
    public function useContactTypesQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'ContactTypes', '\ContactTypesQuery');
    }
