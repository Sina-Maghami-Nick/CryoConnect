...
abstract class CryosphereMethods implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\CryosphereMethodsTableMap';
    ...
    /**
     * Initializes internal state of Base\CryosphereMethods object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\CryosphereMethods The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\CryosphereMethods'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->cryosphereExpertMethodssScheduledForDeletion !== null) {
                if (!$this->cryosphereExpertMethodssScheduledForDeletion->isEmpty()) {
                    \CryosphereExpertMethodsQuery::create()
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CryosphereMethods (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CryosphereMethods Clone of current object.
     * @throws PropelException
     */
    ...
    public function initCryosphereExpertMethodss($overrideExisting = true)
    {
        ...
        $this->collCryosphereExpertMethodss->setModel('\CryosphereExpertMethods');
    }
