...
use \InformationSeekerConnectRequest as ChildInformationSeekerConnectRequest;
use \InformationSeekerConnectRequestLanguagesQuery as ChildInformationSeekerConnectRequestLanguagesQuery;
use \InformationSeekerConnectRequestQuery as ChildInformationSeekerConnectRequestQuery;
...
abstract class InformationSeekerConnectRequestLanguages implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\InformationSeekerConnectRequestLanguagesTableMap';
    ...
    /**
     * Initializes internal state of Base\InformationSeekerConnectRequestLanguages object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\InformationSeekerConnectRequestLanguages The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\InformationSeekerConnectRequestLanguages'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\InformationSeekerConnectRequestLanguages
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \InformationSeekerConnectRequestLanguages (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \InformationSeekerConnectRequestLanguages Clone of current object.
     * @throws PropelException
     */
