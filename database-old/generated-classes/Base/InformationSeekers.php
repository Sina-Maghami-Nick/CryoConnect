...
use \InformationSeekerAffiliation as ChildInformationSeekerAffiliation;
use \InformationSeekerAffiliationQuery as ChildInformationSeekerAffiliationQuery;
...
use \InformationSeekerContact as ChildInformationSeekerContact;
...
use \InformationSeekerProfession as ChildInformationSeekerProfession;
...
use \Exception;
use \PDO;
use Map\InformationSeekerAffiliationTableMap;
...
abstract class InformationSeekers implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\InformationSeekersTableMap';
    ...
    /**
     * Initializes internal state of Base\InformationSeekers object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\InformationSeekers The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\InformationSeekers'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->informationSeekerAffiliationsScheduledForDeletion !== null) {
                if (!$this->informationSeekerAffiliationsScheduledForDeletion->isEmpty()) {
                    \InformationSeekerAffiliationQuery::create()
            ...
            if ($this->informationSeekerConnectRequestsScheduledForDeletion !== null) {
                if (!$this->informationSeekerConnectRequestsScheduledForDeletion->isEmpty()) {
                    \InformationSeekerConnectRequestQuery::create()
            ...
            if ($this->informationSeekerContactsScheduledForDeletion !== null) {
                if (!$this->informationSeekerContactsScheduledForDeletion->isEmpty()) {
                    \InformationSeekerContactQuery::create()
            ...
            if ($this->informationSeekerProfessionsScheduledForDeletion !== null) {
                if (!$this->informationSeekerProfessionsScheduledForDeletion->isEmpty()) {
                    \InformationSeekerProfessionQuery::create()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\InformationSeekers
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \InformationSeekers (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \InformationSeekers Clone of current object.
     * @throws PropelException
     */
    ...
    public function initInformationSeekerAffiliations($overrideExisting = true)
    {
        ...
        $this->collInformationSeekerAffiliations->setModel('\InformationSeekerAffiliation');
    }
    ...
    public function initInformationSeekerConnectRequests($overrideExisting = true)
    {
        ...
        $this->collInformationSeekerConnectRequests->setModel('\InformationSeekerConnectRequest');
    }
    ...
    public function initInformationSeekerContacts($overrideExisting = true)
    {
        ...
        $this->collInformationSeekerContacts->setModel('\InformationSeekerContact');
    }
    ...
    public function initInformationSeekerProfessions($overrideExisting = true)
    {
        ...
        $this->collInformationSeekerProfessions->setModel('\InformationSeekerProfession');
    }
