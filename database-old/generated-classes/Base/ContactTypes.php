...
abstract class ContactTypes implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ContactTypesTableMap';
    ...
    /**
     * Initializes internal state of Base\ContactTypes object.
     */
     ...
     * @return $this|\ContactTypes The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\ContactTypes'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ContactTypes (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ContactTypes Clone of current object.
     * @throws PropelException
     */
