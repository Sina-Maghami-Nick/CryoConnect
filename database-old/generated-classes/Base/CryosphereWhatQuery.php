...
use \Exception;
use \PDO;
use Map\CryosphereWhatTableMap;
 ...
 * @method     ChildCryosphereWhatQuery orderByCryosphereWhat Name($order = Criteria::ASC) Order by the cryosphere_what _name column
 ...
 * @method     ChildCryosphereWhatQuery groupByCryosphereWhat Name() Group by the cryosphere_what _name column
 ...
 *
 * @method     \ExpertCryosphereWhatQuery|\InformationSeekerConnectRequestCryosphereWhatQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildCryosphereWhat findOneByCryosphereWhat Name(string $cryosphere_what _name) Return the first ChildCryosphereWhat filtered by the cryosphere_what _name column
 ...
 * @method     ChildCryosphereWhat requireOneByCryosphereWhat Name(string $cryosphere_what _name) Return the first ChildCryosphereWhat filtered by the cryosphere_what _name column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildCryosphereWhat[]|ObjectCollection findByCryosphereWhat Name(string $cryosphere_what _name) Return ChildCryosphereWhat objects filtered by the cryosphere_what _name column
...
abstract class CryosphereWhatQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\CryosphereWhatQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'cryo_connect', $modelName = '\\CryosphereWhat', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, cryosphere_what _name, timestamp FROM cryosphere_what WHERE id = :p0';
        try {
    ...
    /**
     * Filter the query on the cryosphere_what _name column
     *
     * Example usage:
     * <code>
     * $query->filterByCryosphereWhat Name('fooValue');   // WHERE cryosphere_what _name = 'fooValue'
     * $query->filterByCryosphereWhat Name('%fooValue%', Criteria::LIKE); // WHERE cryosphere_what _name LIKE '%fooValue%'
     * </code>
     *
     * @param     string $cryosphereWhat Name The value to use as filter.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this|ChildCryosphereWhatQuery The current query, for fluid interface
     */
    public function filterByCryosphereWhat Name($cryosphereWhat Name = null, $comparison = null)
    {
        if (null === $comparison) {
            if (is_array($cryosphereWhat Name)) {
                $comparison = Criteria::IN;
            }
        }

        return $this->addUsingAlias(CryosphereWhatTableMap::COL_CRYOSPHERE_WHAT _NAME, $cryosphereWhat Name, $comparison);
    }
