...
abstract class InformationSeekerConnectRequestCryosphereWhat implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\InformationSeekerConnectRequestCryosphereWhatTableMap';
    ...
    /**
     * Initializes internal state of Base\InformationSeekerConnectRequestCryosphereWhat object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\InformationSeekerConnectRequestCryosphereWhat The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\InformationSeekerConnectRequestCryosphereWhat'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\InformationSeekerConnectRequestCryosphereWhat
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \InformationSeekerConnectRequestCryosphereWhat (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \InformationSeekerConnectRequestCryosphereWhat Clone of current object.
     * @throws PropelException
     */
