...
use \CryosphereWhere as ChildCryosphereWhere;
use \CryosphereWhereQuery as ChildCryosphereWhereQuery;
...
/**
 * Base class that represents a row from the 'information_seeker_connect_request_cryosphere_where' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class InformationSeekerConnectRequestCryosphereWhere implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\InformationSeekerConnectRequestCryosphereWhereTableMap';
    ...
    /**
     * Initializes internal state of Base\InformationSeekerConnectRequestCryosphereWhere object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>InformationSeekerConnectRequestCryosphereWhere</code> instance.  If
     * <code>obj</code> is an instance of <code>InformationSeekerConnectRequestCryosphereWhere</code>, delegates to
     * <code>equals(InformationSeekerConnectRequestCryosphereWhere)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|InformationSeekerConnectRequestCryosphereWhere The current object, for fluid interface
     */
     ...
     * @return $this|\InformationSeekerConnectRequestCryosphereWhere The current object (for fluent API support)
     */
    public function setInformationSeekerConnectRequestId($v)
    {
        ...
        if ($this->information_seeker_connect_request_id !== $v) {
            ...
            $this->modifiedColumns[InformationSeekerConnectRequestCryosphereWhereTableMap::COL_INFORMATION_SEEKER_CONNECT_REQUEST_ID] = true;
        }
    ...
    public function setCryosphereWhereId($v)
    {
        ...
        if ($this->cryosphere_where_id !== $v) {
            ...
            $this->modifiedColumns[InformationSeekerConnectRequestCryosphereWhereTableMap::COL_CRYOSPHERE_WHERE_ID] = true;
        }
    ...
    public function setTimestamp($v)
    {
        ...
        if ($this->timestamp !== null || $dt !== null) {
            if ( ($dt != $this->timestamp) // normalized values don't match
                ...
                $this->modifiedColumns[InformationSeekerConnectRequestCryosphereWhereTableMap::COL_TIMESTAMP] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : InformationSeekerConnectRequestCryosphereWhereTableMap::translateFieldName('InformationSeekerConnectRequestId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->information_seeker_connect_request_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : InformationSeekerConnectRequestCryosphereWhereTableMap::translateFieldName('CryosphereWhereId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cryosphere_where_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : InformationSeekerConnectRequestCryosphereWhereTableMap::translateFieldName('Timestamp', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = InformationSeekerConnectRequestCryosphereWhereTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\InformationSeekerConnectRequestCryosphereWhere'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildInformationSeekerConnectRequestCryosphereWhereQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see InformationSeekerConnectRequestCryosphereWhere::setDeleted()
     * @see InformationSeekerConnectRequestCryosphereWhere::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildInformationSeekerConnectRequestCryosphereWhereQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                InformationSeekerConnectRequestCryosphereWhereTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(InformationSeekerConnectRequestCryosphereWhereTableMap::COL_INFORMATION_SEEKER_CONNECT_REQUEST_ID)) {
            $modifiedColumns[':p' . $index++]  = 'information_seeker_connect_request_id';
        }
        if ($this->isColumnModified(InformationSeekerConnectRequestCryosphereWhereTableMap::COL_CRYOSPHERE_WHERE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'cryosphere_where_id';
        }
        if ($this->isColumnModified(InformationSeekerConnectRequestCryosphereWhereTableMap::COL_TIMESTAMP)) {
            $modifiedColumns[':p' . $index++]  = 'timestamp';
        }

        $sql = sprintf(
            'INSERT INTO information_seeker_connect_request_cryosphere_where (%s) VALUES (%s)',
    ...
    {
        $pos = InformationSeekerConnectRequestCryosphereWhereTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['InformationSeekerConnectRequestCryosphereWhere'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['InformationSeekerConnectRequestCryosphereWhere'][$this->hashCode()] = true;
        $keys = InformationSeekerConnectRequestCryosphereWhereTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\InformationSeekerConnectRequestCryosphereWhere
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(InformationSeekerConnectRequestCryosphereWhereTableMap::COL_TIMESTAMP)) {
            $criteria->add(InformationSeekerConnectRequestCryosphereWhereTableMap::COL_TIMESTAMP, $this->timestamp);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \InformationSeekerConnectRequestCryosphereWhere (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \InformationSeekerConnectRequestCryosphereWhere Clone of current object.
     * @throws PropelException
     */
    ...
    public function setInformationSeekerConnectRequest(ChildInformationSeekerConnectRequest $v = null)
    {
        ...
        if ($v !== null) {
            $v->addInformationSeekerConnectRequestCryosphereWhere($this);
        }
    ...
    public function getInformationSeekerConnectRequest(ConnectionInterface $con = null)
    {
        if ($this->aInformationSeekerConnectRequest === null && ($this->information_seeker_connect_request_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aInformationSeekerConnectRequest->addInformationSeekerConnectRequestCryosphereWheres($this);
             */
        }
    ...
    public function getCryosphereWhere(ConnectionInterface $con = null)
    {
        if ($this->aCryosphereWhere === null && ($this->cryosphere_where_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCryosphereWhere->addInformationSeekerConnectRequestCryosphereWheres($this);
             */
        }
    ...
    {
        if (null !== $this->aInformationSeekerConnectRequest) {
            $this->aInformationSeekerConnectRequest->removeInformationSeekerConnectRequestCryosphereWhere($this);
        }
        if (null !== $this->aCryosphereWhere) {
            $this->aCryosphereWhere->removeInformationSeekerConnectRequestCryosphereWhere($this);
        }
    ...
    {
        return (string) $this->exportTo(InformationSeekerConnectRequestCryosphereWhereTableMap::DEFAULT_STRING_FORMAT);
    }
