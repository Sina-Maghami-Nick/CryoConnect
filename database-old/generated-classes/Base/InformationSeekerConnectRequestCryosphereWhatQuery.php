 ...
 *
 * @method     \InformationSeekerConnectRequestQuery|\CryosphereWhatQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class InformationSeekerConnectRequestCryosphereWhatQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\InformationSeekerConnectRequestCryosphereWhatQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'cryo_connect', $modelName = '\\InformationSeekerConnectRequestCryosphereWhat', $modelAlias = null)
    {
