 ...
 *
 * @method     \ExpertCareerStageQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class CareerStageQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\CareerStageQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'cryo_connect', $modelName = '\\CareerStage', $modelAlias = null)
    {
