...
abstract class ExpertWhere implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ExpertWhereTableMap';
    ...
    /**
     * Initializes internal state of Base\ExpertWhere object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\ExpertWhere The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\ExpertWhere'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ExpertWhere (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ExpertWhere Clone of current object.
     * @throws PropelException
     */
