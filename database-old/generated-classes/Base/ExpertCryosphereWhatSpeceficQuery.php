 ...
 *
 * @method     \ExpertsQuery|\CryosphereWhatSpeceficQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class ExpertCryosphereWhatSpeceficQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\ExpertCryosphereWhatSpeceficQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'cryo_connect', $modelName = '\\ExpertCryosphereWhatSpecefic', $modelAlias = null)
    {
     ...
     *
     * @param \CryosphereWhatSpecefic|ObjectCollection $cryosphereWhatSpecefic The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($cryosphereWhatSpecefic instanceof \CryosphereWhatSpecefic) {
            return $this
            ...
            throw new PropelException('filterByCryosphereWhatSpecefic() only accepts arguments of type \CryosphereWhatSpecefic or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \CryosphereWhatSpeceficQuery A secondary query class using the current class as primary query
     */
    public function useCryosphereWhatSpeceficQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'CryosphereWhatSpecefic', '\CryosphereWhatSpeceficQuery');
    }
